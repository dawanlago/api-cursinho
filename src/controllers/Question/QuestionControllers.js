...
class QuestionController {
    ...
    async store(req, res) {
        const { description, discipline, subject, jury, year, level, difficulty, modality, commentedTemplate, answers, answerCorrect, feedback, company } = req.body;
    ...
    async update(req, res) {
        ...
        const question = await Question.updateOne({ _id: question_id }, {
    ...
    async addAnswer(req, res) {
        ...
        const questionUpdate = await Question.updateOne({ _id: question_id }, {
